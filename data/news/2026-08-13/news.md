...
- **[Grok 4.6](https://x.ai/news/grok-4-6)** _HackerNews-Grok_ — <a href="https:&#x2F;&#x2F;artificialanalysis.ai&#x2F;articles&#x2F;grok-4-6-benchmarks-and-analysis" rel="nofollow">https:&#x2F;&#x2F;artificialanalysis.ai&#x2F;articles&#x2F;grok-4-6-benchmarks-a...
...
- **[Why Does CLAUDE.md Keep Growing? Catastrophic Remembering in Agentic Coding](https://arxiv.org/abs/2608.11095v1)** _ArXiv-cs.AI_ — Agentic coding READMEs like CLAUDE.md grow without bound in real repositories, stopping only when the repository retires or someone rewrites the file wholesale. We trace this to imperfect recall: appe
- **[Grok Bot by SpaceXAI](https://x.ai/news/introducing-grok-bot)** _HackerNews-Grok_ — 
- **[Grok is now an AI ‘teammate’ you can assign work](https://www.theverge.com/ai-artificial-intelligence/978666/spacexai-grok-bot-ai-agent-beta-launch)** _TheVerge-AI_ — SpaceXAI has introduced Grok Bot, an always-on AI agent service designed to behave like independent "AI teammates" that can do your work for you. The bots share their own cloud-based computer environm
...
- **[Regarding the Anthropic and Watermark Issue](https://twitter.com/kimmonismus/status/2087475010050920549)** _HackerNews-Kimi_ — 
- **[Apple could help you prove your iPhone photos aren’t deepfakes](https://www.theverge.com/tech/977921/apple-reference-image-iphone-metadata)** _TheVerge-AI_ — Apple is seemingly developing an iOS feature that can verify when a photograph was taken using an iPhone camera. 9to5Mac reports that the iOS 27 beta 5 includes code references for an "Apple Reference
- **[Launch HN: Keet (YC S24) – An app to create video courses on anything](https://www.trykeet.com/)** _HackerNews-Kimi_ — Hi HN! We’re Zack and Tommy the Co-Founders of Keet (<a href="https:&#x2F;&#x2F;trykeet.com">https:&#x2F;&#x2F;trykeet.com</a>). We are building a mobile app that generates courses on any topic, with 
- **[A Comparative Evaluation of Deep Learning Object Detection Models on a Real-World Multi-Plant Dataset from Africa](https://arxiv.org/abs/2608.11053v1)** _ArXiv-cs.AI_ — The application of computer vision in agriculture has shown significant potential for improving crop monitoring and precision farming. However, many existing approaches rely on controlled datasets tha
- **[Entropy-Centric Explainable AI for Remote Sensing Image Segmentation](https://arxiv.org/abs/2608.11064v1)** _ArXiv-cs.AI_ — Artificial intelligence (AI) has become a powerful approach to solving complex problems in critical domains. Many concerns arise regarding the decision-making process of its models, mainly due to deep
- **[Quantum Coordination Advantages in AI State-Tracking Tasks: Semantic Compilation and Latent Memory](https://arxiv.org/abs/2608.11066v1)** _ArXiv-cs.AI_ — We prove inference-time quantum coordination advantages for specified AI state-tracking tasks. A solver compresses semantic history into a future-accessible boundary state and later answers a query. W
...
- **[Seedance 2.5测评｜ 七维实测，AI视频从片段到叙事，到底进步了多少？](https://36kr.com/p/3936379078409606?f=rss)** _36氪_ — <p>上半场比的是什么？比谁的数据集更干净、谁的视频动作更连贯、谁的分辨率更高。可落到真实创作场景就会发现，AI视频真正的瓶颈，远不止这些参数的比拼。</p>
  <p>&nbsp;</p>
  <p><strong>7月31日，Seedance 2.5正式发布上线。</strong></p>
  <p>为此<strong>36氪AI测评团队</strong>及<strong>27位36氪AI测评
- **[最前线｜3999元起，影石发布X6：全景相机开始把更多创作交给AI](https://36kr.com/p/3936487630650758?f=rss)** _36氪_ — <p>文｜张子怡</p>
  <p>编辑｜袁斯来</p>
  <p>&nbsp;8月12日，影石Insta360在其布局全景相机的第十年，发布了新一代旗舰全景相机X6，中国大陆地区售价3999元起。 &nbsp;</p>
